...
if importlib.util.find_spec("arcgis_overture") is None:
    src_dir = find_pkg_source("arcgis_overture")
...
class Toolbox:
    def __init__(self):
        ...
        self.label = "arcgis-overture"
        self.alias = "arcgis_overture"
...
class CreateDataDirectory:
    ...
    def execute(self, parameters, messages):
        ...
        arcgis_overture.utils.configure_logging("INFO")
        ...
        arcgis_overture.utils.build_data_resources(dir_data)
